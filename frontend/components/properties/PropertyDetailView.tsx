        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="grid grid-cols-3 gap-4 backdrop-blur-xl bg-slate-800/50 border border-white/10 rounded-3xl p-6 shadow-xl">
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <div className="text-blue-200/50 text-xs uppercase tracking-wider">Bedrooms</div>
            </div>
            <div className="flex flex-col items-center gap-2 text-center border-x border-white/10 px-4 text-center">
              ...
              <div className="text-blue-200/50 text-xs uppercase tracking-wider">Bathrooms</div>
            </div>
            <div className="flex flex-col items-center gap-2 text-center">
              <Ruler className="w-6 h-6 text-blue-400" />
              <div className="text-white font-bold text-lg">{property.sqft}</div>
              <div className="text-blue-200/50 text-xs uppercase tracking-wider">sqft Area</div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="sticky top-24 backdrop-blur-2xl bg-slate-900/80 border border-white/10 rounded-[2.5rem] p-8 shadow-2xl space-y-6">
            <div className="space-y-1">
              <div className="text-blue-200/50 text-sm font-medium uppercase tracking-widest">Monthly Rent</div>
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-white">{property.price}</span>
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-600 p-0.5 shadow-lg">
                  <div className="w-full h-full rounded-full bg-slate-900 flex items-center justify-center text-white font-bold text-xl overflow-hidden">
                    {property.manager.avatar ? (
                      <img src={property.manager.avatar} alt={property.manager.name} className="w-full h-full object-cover" />
                    ) : (
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    <span className="font-bold text-white text-lg">{property.manager.name}</span>
                    {property.manager.verified && <Shield className="w-4 h-4 text-blue-400" />}
                  </div>
                  <div className="text-blue-200/50 text-sm">Response time: {property.manager.responseTime}</div>
                </div>
              </div>
