...
export default function PropertyMap({ properties, className = "h-[400px] md:h-[600px] w-full" }: PropertyMapProps) {
  return (
    <div className={`relative overflow-hidden rounded-[2.5rem] border border-white/10 shadow-2xl ${className}`}>
      ...
      <div className="absolute top-6 left-6 z-10 hidden sm:block">
        <div className="backdrop-blur-xl bg-slate-900/80 border border-white/10 px-6 py-4 rounded-2xl shadow-2xl space-y-1">
          <h3 className="text-white font-bold tracking-tight">Interactive View</h3>
